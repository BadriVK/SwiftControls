...
func callback(reachability:SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutablePointer<Void>) {
    let reachability = Unmanaged<AVReachability>.fromOpaque(COpaquePointer(info)).takeUnretainedValue()
...
public class AVReachability: NSObject {
    
    public typealias NetworkReachable = (AVReachability) -> ()
    public typealias NetworkUnreachable = (AVReachability) -> ()
    ...
    public class func reachabilityForInternetConnection() -> AVReachability? {
        ...
        return AVReachability(reachabilityRef: ref)
    }
    
    public class func reachabilityForLocalWiFi() -> AVReachability? {
